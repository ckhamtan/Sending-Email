...
like this, that, and the other othing.</p>';

// Check if the form ahs been submitted:
...
$problem = true;
print '<p class="text--
error">Please enter your password!</p>';
}

if ($_POST['password1'] != 
$_POST['password2']) {
$problem = true;
print '<p class="text--error">Your
...
// Print a message:
print '<p class="text--success">Your are now registered!<br>Okay, you are not really registered but...</p>';
...
<p><label for="email">Email Address:</label><input type="text" name="email" size="20" 
...
<?php include('template/footer.html'); // Need the footer. 
?>
